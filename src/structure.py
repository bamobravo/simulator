class Memory(object):
	...
	def __init__(self,initialData, blocks,blockSize):
		self.size = size #the block size of the memory
		self.iCache=InstructionCache(blocks,blockSize)
		self.dCache = DataCache(4,4)#this is the cache location that help find the hit
